...
- [utility](https://github.com/anupyldd/utility) – a set of utility headers, including:
  ...
  - a logger
  - a timer
- [PicoJSON Serialization](https://github.com/anupyldd/picojson-serialization) - helper for simplifying JSON serialization/deserialization using PicoJSON
...
I'm open to collaboration, work, or just chatting, so feel free to contact me:
  
- **dsanupyld@gmail.com**  
- **Outdoordoor** (Discord, Reddit)
